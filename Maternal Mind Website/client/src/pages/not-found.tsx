    ...
    <div className="min-h-screen bg-void flex items-center justify-center px-4">
      ...
      <ScrollReveal>
        <GlassCard className="max-w-md w-full p-8 text-center">
          <div className="w-16 h-16 rounded-xl bg-[#11a4d4]/10 border border-[#11a4d4]/20 flex items-center justify-center mx-auto mb-6 shadow-[0_0_20px_rgba(17,164,212,0.2)]">
            <MaternalMindLogo size={40} glowing />
          </div>
